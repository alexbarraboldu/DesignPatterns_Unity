...
public class LauncherEditor : Editor
{
	...
	public static void DrawGizmosSelected(Launcher launcher, GizmoType gizmoType)
	{
		var offsetPosition = launcher.transform.TransformPoint(launcher.offset);//launcher.transform.position + launcher.offset;
		...
		if (launcher.projectile != null)
		{
			...
			Vector3 velocity = launcher.transform.forward *
				launcher.velocity /
